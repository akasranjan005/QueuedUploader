...
set CLASSPATH=%APP_HOME%\lib\jadx-cli-0.5.2.jar;%APP_HOME%\lib\android-4.3.jar;%APP_HOME%\lib\dx-1.8.jar;%APP_HOME%\lib\slf4j-api-1.7.7.jar;%APP_HOME%\lib\jadx-core-0.5.2.jar;%APP_HOME%\lib\jcommander-1.35.jar;%APP_HOME%\lib\logback-classic-1.1.2.jar;%APP_HOME%\lib\asm-5.0.3.jar;%APP_HOME%\lib\logback-core-1.1.2.jar
