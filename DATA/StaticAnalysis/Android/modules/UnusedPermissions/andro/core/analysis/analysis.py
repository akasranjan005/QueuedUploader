# This file is part of andro.
#
# Copyright (C) 2012, Anthony Desnos <desnos at t0t0.fr>
# All rights reserved.
#
# andro is free software: you can redistribute it and/or modify
# it under the terms of the GNU Lesser General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# andro is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU Lesser General Public License for more details.
#
# You should have received a copy of the GNU Lesser General Public License
# along with andro.  If not, see <http://www.gnu.org/licenses/>.

import re, random, string, cPickle

from andro.core.androconf import error, warning
from andro.core.bytecodes import jvm, dvm
from andro.core.bytecodes.api_permissions import DVM_PERMISSIONS_BY_PERMISSION, DVM_PERMISSIONS_BY_ELEMENT
...
class TaintedPackages :
    ...
    def search_methods(self, class_name, name, descriptor, re_expr=True) :
        ...
        if re_expr == True :
            ...
            for m, _ in self.get_packages() :
                if ex.match( m.get_info() ) != None :
                    # Modified by Wenjun Hu
                    # Break if find
                    searched_method_list = m.search_method(name, descriptor)
                    if searched_method_list:
                        l.extend( searched_method_list)
                        break
